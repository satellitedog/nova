...
void OptionsModel::Init()
{
    ...
    fUseAmmoTheme = settings.value("fUseAmmoTheme", true).toBool();
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseAmmoTheme:
            fUseAmmoTheme = value.toBool();
            settings.setValue("fUseAmmoTheme", fUseAmmoTheme);
            break;
        default:
            break;
        }
