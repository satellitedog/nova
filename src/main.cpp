...
const string strMessageMagic = "Ammo Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // AMMO
    {
        nSubsidy = 7777777 * COIN;
    }
...
return nSubsidy + nFees;
    ...
    else if(pindexBest->nHeight > 180000) // 695k During Ammo Reward DpoS for 2 Months After 1 AMMO each block 
    {
    nSubsidy = 1 * COIN;
return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ammo", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1494167992;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1665507;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf13b198ad8570c934046a27094d602e6afdeba1199ae0e8a9da8061c5f2dcc4a"));
